...
# Defining commodities, measurement units and names:
commodities_info = {
    ...
    "RB=F": {"unit": "gallons", "name": "Gasoline (BOB)"},
...
def main_app():
    ...
    period = st.sidebar.selectbox("Select Period", ["1d", "5d", "1mo", "3mo", "6mo", "1yr"], index=3)
